...
import 'package:todo_app_reverpod/features/todo/pages/add.dart';
import 'package:todo_app_reverpod/features/todo/widgets/completed_task.dart';
import 'package:todo_app_reverpod/features/todo/widgets/dayAfterTomo.dart';
import 'package:todo_app_reverpod/features/todo/widgets/todayTask.dart';
import 'package:todo_app_reverpod/features/todo/widgets/tomorrow_list.dart';
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: GestureDetector(
                            ...
                            child:
                                const Icon(Icons.add, color: AppConst.kBkDrark),
                          ))
                    ],
                  ),
                ),
                        ...
                        child: SizedBox(
                          ...
                          child: Center(
                            child: ReusableText(
                                text: 'Pending',
                                style: appstyle(
                                    16, AppConst.kBkDrark, FontWeight.bold)),
                          ),
                        ),
                      ),
                      Tab(
